...
const RentModal = () => {
  ...
  // data here gets populated through react hook form
  ...
  // dynamic body content based on the step
  let bodyContent = (
    <div className="flex flex-col gap-8">
      <Heading
        title="Which of these places describes your place?"
    ...
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading
          ...
          subtitle="Show guestswhat your place looks like!"
        />
        <ImageUpload
          value={imageSrc}
          onChange={(link) => setCustomValue("imageSrc", link)}
        />
      </div>
    );
  }
